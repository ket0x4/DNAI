...
import static f.doop.dnai.ThemerConstants.APK_SIGNATURE_PRODUCTION;
import static f.doop.dnai.ThemerConstants.BASE_64_LICENSE_KEY;
import static f.doop.dnai.ThemerConstants.BLACKLISTED_APPLICATIONS;
import static f.doop.dnai.ThemerConstants.ENABLE_BLACKLISTED_APPLICATIONS;
import static f.doop.dnai.ThemerConstants.ENFORCE_AMAZON_APP_STORE_INSTALL;
import static f.doop.dnai.ThemerConstants.ENFORCE_GOOGLE_PLAY_INSTALL;
import static f.doop.dnai.ThemerConstants.ENFORCE_INTERNET_CHECK;
import static f.doop.dnai.ThemerConstants.ENFORCE_MINIMUM_SUBSTRATUM_VERSION;
import static f.doop.dnai.ThemerConstants.MINIMUM_SUBSTRATUM_VERSION;
import static f.doop.dnai.ThemerConstants.PIRACY_CHECK;
import static f.doop.dnai.ThemerConstants.SUBSTRATUM_FILTER_CHECK;
import static f.doop.dnai.ThemerConstants.THEME_READY_GOOGLE_APPS;
